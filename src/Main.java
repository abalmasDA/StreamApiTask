 ...
 * 3.1 Даний клас Task1.Product, який складається з властивостей:
 * - тип
 * - ціна
 * - можливість застосування знижки
 ...
 * 4.1 Даний клас Task1.Product, який складається з властивостей:
 * - тип
 * - ціна
 * - можливість застосування знижки
 ...
 * 5.1 Цей клас Task1.Product, який складається з властивостей:
 * - тип
 * - ціна
 * - можливість застосування знижки
 * - дата додавання (можна використовувати тип даних java.time.LocalDate, java.time.LocalDateTime або java.util.Date
 ...
 * ** 6.1 Дан клас Task1.Product, який складається з властивостей:
